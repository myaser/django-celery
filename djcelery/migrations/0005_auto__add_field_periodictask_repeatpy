...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PeriodicTask.repeat'
        db.add_column('djcelery_periodictask', 'repeat',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PeriodicTask.repeat'
        db.delete_column('djcelery_periodictask', 'repeat')
